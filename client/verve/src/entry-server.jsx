...
// defeating the point of SSR. ThemeProvider's initial theme is always "dark" here (no
// `document` to read on the server) — see ThemeToggle.jsx for how that gap is bridged.
